...
(* OASIS_START *)
(* DO NOT EDIT (digest: 6d807c67843c4cbdcff91c9c28b5073f) *)
(*
...
let setup_t =
  {
            ...
            [
               Library
                 ({
                  ...
                  },
                   {
                      ...
                      bs_byteopt =
                        [(OASISExpr.EBool true, ["-warn-error"; "+1..45"])];
                      bs_nativeopt =
                        [(OASISExpr.EBool true, ["-warn-error"; "+1..45"])]
                   },
                   {
                      lib_modules = ["Ffi_bindings"];
                      lib_pack = false;
               ...
               Library
                 ({
                  ...
                  },
                   {
                      ...
                      bs_cclib = [(OASISExpr.EBool true, ["-lpci"])];
                      bs_dlllib = [(OASISExpr.EBool true, [])];
                      bs_dllpath = [(OASISExpr.EBool true, [])];
                      bs_byteopt =
                        [(OASISExpr.EBool true, ["-warn-error"; "+1..45"])];
               ...
               Doc
                 ({
                  ...
                  },
                   {
                      ...
                      doc_title = "API reference for Pci";
                      doc_authors = [];
                      doc_abstract = None;
                      doc_format = OtherDoc;
                      doc_data_files = [];
               ...
               Executable
                 ({
                  ...
                  },
                   {
                      ...
                      bs_build_depends = [InternalLibrary "pci_bindings"];
                      bs_build_tools = [ExternalTool "ocamlbuild"];
                      bs_c_sources = [];
                      bs_data_files = [];
                      bs_ccopt = [(OASISExpr.EBool true, [])];
               ...
               Executable
                 ({
                   ...
                   {exec_custom = false; exec_main_is = "test_pci.ml"});
               Test
                 ({
                     cs_name = "test_pci";
                     cs_data = PropList.Data.create ();
               ...
               Flag
                 ({
                   ...
                   {
                      flag_description = Some "Compile example executables";
               ...
               Executable
                 ({
                  ...
                  },
                   {
                      ...
                      bs_path = "examples";
                      bs_compiled_object = Best;
                      bs_build_depends = [InternalLibrary "pci"];
                      bs_build_tools = [ExternalTool "ocamlbuild"];
                      bs_c_sources = [];
                      bs_data_files = [];
                      bs_ccopt = [(OASISExpr.EBool true, [])];
                   ...
                   {exec_custom = false; exec_main_is = "lspci.ml"})
            ];
          plugins =
     ...
     oasis_version = "0.4.5";
     oasis_digest = Some "\195\176\235u\219TA\137g\225\018\240\159\018\252,";
     oasis_exec = None;
     oasis_setup_args = [];
     setup_update = false
  };;
