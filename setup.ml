...
(* OASIS_START *)
(* DO NOT EDIT (digest: 93b62cb911b520d3de74138b8a49fc68) *)
(*
...
let setup_t =
  {
            ...
            [
               Executable
                 ({
                   ...
                   {exec_custom = false; exec_main_is = "pci_stubgen.ml"});
               Library
                 ({
                     cs_name = "pci";
                     cs_data = PropList.Data.create ();
                  ...
                  },
                   {
                      ...
                      bs_build_tools =
                        [
                           ...
                           InternalExecutable "pci_stubgen"
                        ];
                      bs_c_sources = ["pci_stubs.c"];
                      bs_data_files = [];
                      bs_ccopt =
                        [
                   ...
                   {
                      lib_modules = ["Pci_generated"];
                      lib_pack = false;
                      lib_internal_modules = ["Pci_bindings"];
     ...
     oasis_version = "0.4.5";
     oasis_digest =
       Some "\144\143\223\031\004\247\135\168\229\1946\220\015\160\155@";
     oasis_exec = None;
     oasis_setup_args = [];
     setup_update = false
  };;
